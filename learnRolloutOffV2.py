...
def insertToMongo(dictInsert,agentID):
    ...
    collection = db[f'mode_20_Q_Agent{agentID}']  # Replace 'your_collection_name' with your actual collection name
...
if __name__ == '__main__':
    ...
    # train_samples = generate_samples(N_SAMPLES)


    # train_samples = retrieveRandomFromMongo(50000)
    # # t2 = perf_counter()
